...
const ExploreSection = () => {
    ...
    visible: {
  ...
  };    return (    <section className="bg-[#F8F1E9] relative overflow-hidden h-screen flex items-center">
      ...
      <div className="absolute bottom-20 right-10 w-32 h-32 rounded-full bg-blue-100 opacity-30 blur-3xl"></div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4 w-full">
          {/* Left side: Text content */}          <motion.div
            initial="hidden"
          ...
          >            {/* Texture background image */}            <motion.img 
            ...
            >
              <span className="text-4xl md:text-5xl lg:text-6xl inline-block mr-1">E</span>xplore our top nft art works.
            </motion.h2>
            <p>
            ...
            >
              View Collection            </motion.button></motion.div>          {/* Right side: Grid Gallery with rotation */}
