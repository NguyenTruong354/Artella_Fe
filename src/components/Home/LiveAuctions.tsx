          ...
          >
            ...
            <div className="flex-grow min-w-0">
              ...
              <div className="flex items-center space-x-3">                <motion.button
                ...
                <div className="flex-shrink-0 text-xs px-3 py-2.5 rounded-lg border transition-all duration-300 text-gray-600 bg-gradient-to-r from-gray-100 to-gray-200 border-gray-300/50 dark:text-gray-400 dark:bg-gradient-to-r dark:from-gray-800 dark:to-gray-700 dark:border-gray-600/50">
                  <div className="flex items-center space-x-2">
