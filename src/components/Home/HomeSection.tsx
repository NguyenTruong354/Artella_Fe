  ...
  const featuredArtworks: ArtworkData[] = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1547826039-bfc35e0f1ea8?w=400&h=500&fit=crop", // Placeholder, use relevant images
    ...
    },
    {
      ...
      dimensions: "1080x1080px",
      image:
        "https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?w=400&h=500&fit=crop", // Placeholder
      currentBid: "2.50 ETH",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?w=400&h=500&fit=crop", // Placeholder
      currentBid: "3.40 ETH",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1579965342575-15475c126358?w=400&h=500&fit=crop", // Placeholder
      currentBid: "2.43 ETH",
                    ...
                    <motion.button
                      className={`text-xs font-semibold px-4 py-2 rounded-lg transition-all duration-300 ${
                        index % 2 === 0
                          ...
                          : "border border-purple-500/50 text-purple-400 hover:bg-purple-500 hover:text-white hover:border-purple-500"
                      }`}
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                    >
                  ...
                  >
                    <div className="relative">
                      <img
                        src={auction.image}
                        alt={auction.title}
                        className="w-20 h-20 object-cover rounded-xl flex-shrink-0 transition-transform duration-300 group-hover:scale-105 border border-gray-300/50 dark:border-gray-700/50"
                      />
                    ...
                    <div className="flex-grow">
                      <h3 className="text-sm font-bold truncate mb-2 transition-colors text-gray-900 group-hover:text-pink-600 dark:text-white dark:group-hover:text-pink-400">
                        {auction.title}
                      </h3>
