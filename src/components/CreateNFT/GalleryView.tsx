...
const GalleryView: React.FC<GalleryViewProps> = ({
  ...
  const backgroundOptions = [
    ...
    { key: 'gradient', label: 'Gradient', icon: <Palette className="w-4 h-4" /> },
  ...
  const lightingOptions = [
    ...
    { key: 'spotlight', label: 'Spotlight', icon: <Lightbulb className="w-4 h-4" /> },
    { key: 'ambient', label: 'Ambient', icon: <Camera className="w-4 h-4" /> }
  ];

  const environmentOptions = [
    { key: 'gallery', label: 'Gallery', icon: <Building2 className="w-4 h-4" /> },
  ...
  return (
    <div className="h-full space-y-6">
      ...
      >
        ...
        <div className={`rounded-2xl p-8 min-h-[400px] ${getBackgroundClass()} relative overflow-hidden`}>
          ...
          <div className="flex items-center justify-center h-full">
            <div className={`relative ${getFrameClass()} ${getLightingEffect()} max-w-md`}>
              {nftMetadata.image ? (
                <img 
      ...
      >
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
            ...
            <span className="text-sm font-semibold">{nftMetadata.category}</span>
          </div>
          
          <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Royalty</span>
            <span className="text-sm font-semibold">{nftMetadata.royalty}%</span>
          </div>
