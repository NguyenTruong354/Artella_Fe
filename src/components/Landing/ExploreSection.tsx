...
const ExploreSection = () => {
  ...
  const mainImageUrl = "https://res.cloudinary.com/dkxpy5kg2/image/upload/v1748527233/background_9_kpnd1e.jpg";
      ...
      <div className="container mx-auto px-4 py-1 md:py-2 flex flex-col justify-center min-h-0">
        ...
        <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4 w-full">
          ...
          >
            ...
            <motion.img
              src="https://res.cloudinary.com/dkxpy5kg2/image/upload/v1748527197/textxure_3_ejs85r.png"
              alt="Texture"
