...
const AboutSection: React.FC = () => {
  return (
    <section className="relative min-h-screen w-full bg-[#F8F1E9] flex flex-col">
      ...
      <div className="flex-1 flex flex-col md:flex-row items-center justify-between px-4 md:px-8 lg:px-12 relative z-20">
        ...
        {/* Phần text bên phải */}
        <motion.div 
          className="w-full md:w-1/2 text-center md:text-left px-4 md:px-8 lg:px-12 mt-8 md:mt-0"
